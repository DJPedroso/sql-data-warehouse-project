...
Purpose:
  ...
  warehouse. The Gold layer represents the final 
  business-ready dimension and fact tables organized in a 
  star schema.

  Each view performs transformations and combines data from
  the Silver layer to produce a clean, enriched, and
...
LEFT JOIN silver.erp_px_cat_g1v2 AS pc
    ON pn.cat_id = pc.id
WHERE pn.prd_end_dt IS NULL; -- Keep current product records only
